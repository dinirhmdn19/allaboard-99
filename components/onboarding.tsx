...
const ENDING_PAGE_SECTIONS: EndingSection[] = [
  {
    ...
    socialLinks: [
      ...
      { label: 'TikTok', href: 'https://www.tiktok.com/@lifeat99group', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/tiktok.png' },
    ],
  },
  {
    title: 'RUMAH123',
    ...
    socialLinks: [
      ...
      { label: 'TikTok', href: 'https://www.tiktok.com/@rumah123com', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/tiktok.png' },
      { label: 'YouTube', href: 'https://www.youtube.com/channel/UCQRpkeIymZhbrMHsvgRxf2Q?sub_confirmation=1', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/youtube.png' },
      { label: 'X', href: 'https://twitter.com/rumah123', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/x.png' },
      { label: 'Facebook', href: 'https://www.facebook.com/Rumah123/', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/facebook.png' },
    ],
  },
  {
    title: '99.CO',
    ...
    socialGroups: [
      {
        ...
        links: [
          ...
          { label: 'Indonesia X', href: 'https://twitter.com/99dotco_IDN', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/x.png' },
          { label: 'Indonesia Facebook', href: 'https://www.facebook.com/99indonesia', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/facebook.png' },
        ],
      },
      {
        title: 'Singapore',
        links: [
          ...
          { label: 'Singapore TikTok', href: 'https://www.tiktok.com/@99dotco', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/tiktok.png' },
          { label: 'Singapore Facebook', href: 'https://www.facebook.com/99dotco', icon: 'https://jjxkerecburodqgabafh.supabase.co/storage/v1/object/public/logos/facebook.png' },
        ],
      },
    ],
  },
